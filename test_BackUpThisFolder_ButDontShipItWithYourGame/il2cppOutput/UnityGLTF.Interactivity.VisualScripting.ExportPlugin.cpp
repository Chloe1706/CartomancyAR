...
{
	{
		//<source_info:./Library/PackageCache/org.khronos.unitygltf@90871535206a/Runtime/Scripts/Interactivity/VisualScripting/Plugin/VisualScriptingExportPlugin.cs:35>
		return (bool)1;
	}
}
